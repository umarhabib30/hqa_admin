...
<head>
    ...
    <title>New Alumni Form Submitted</title>
</head>
<body style="margin:0; padding:24px; background:#f6f7fb; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;">
    <div style="max-width:600px; margin:0 auto;">
        <div style="background:#00285E; border-radius:16px; padding:22px; color:#fff;">
            <h1 style="margin:0 0 8px 0; font-size:22px;">New alumni form submitted</h1>
            <p style="margin:0; font-size:14px; opacity:0.95;">A new alumni form has been submitted.</p>
        </div>

        <div style="background:#ffffff; border:1px solid #e5e7eb; border-radius:16px; margin-top:14px; padding:24px;">
            <p style="color:#374151; margin:0 0 16px 0;">Submitter details:</p>
            <table style="width:100%; border-collapse:collapse; margin-bottom:20px;">
                ...
                <tr>
                    ...
                    <td style="padding:6px 0; color:#111827;">{{ $form->phone ?? '—' }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding:6px 0; color:#111827;">{{ $form->created_at?->format('M d, Y \a\t H:i') ?? '—' }}</td>
                </tr>
            </table>
        ...
        <p style="margin-top:16px; text-align:center; color:#9ca3af; font-size:12px;">{{ config('app.name') }} – Alumni Forms</p>
    </div>
</body>
</html>
