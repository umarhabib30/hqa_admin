...
@section('content')
    ...
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('socials.store') }}" class="space-y-6">
            ...
            <input name="fblink" type="url" placeholder="https://facebook.com/yourpage" class="w-full border p-3 rounded"
                required>
            <input name="ytlink" type="url" placeholder="https://Youtube.com/yourpage" class="w-full border p-3 rounded"
                required>
            <input name="tiktoklink" type="url" placeholder="https://Instagram.com/yourpage" class="w-full border p-3 rounded"
                required>
            <input name="instalink" type="url" placeholder="https://Tiktok.com/yourpage" class="w-full border p-3 rounded"
                required>
