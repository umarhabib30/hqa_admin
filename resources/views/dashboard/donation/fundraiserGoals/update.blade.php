...
<div class="mx-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <div>
            <h1 class="text-[28px] font-semibold text-gray-800">
                Update FundRaise Goal
            </h1>

            <div class="text-sm text-gray-500 mt-1">
                Dashboard / FundRaise Goals / Update
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <form method="POST"
            action="{{ route('fundRaise.update', $fundRaise->id) }}"
            class="space-y-6">
            ...
            <div>
                ...
                <input type="number"
                    name="starting_goal"
                    value="{{ old('starting_goal', $fundRaise->starting_goal) }}"
            ...
            <div>
                ...
                <input type="number"
                    name="ending_goal"
                    value="{{ old('ending_goal', $fundRaise->ending_goal) }}"
                    class="w-full px-4 py-3 rounded-lg
                              border border-gray-300
                              focus:ring-2 focus:ring-[#00285E]
                              focus:outline-none">
