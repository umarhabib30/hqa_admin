...
@section('content')
    ...
    <div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('donationImage.store') }}">
            @csrf

            <!-- FILE INPUT -->
            <input type="file" name="images[]" id="imageInput" multiple accept="image/*" class="mb-4 block w-full border-[#00285E] border-2 p-3">
