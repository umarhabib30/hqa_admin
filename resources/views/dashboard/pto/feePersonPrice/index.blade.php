...
@section('content')
    ...
    <div class="hidden md:block bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="overflow-x-auto p-4">
            <table id="ptoFeeTable" class="display w-full text-left" style="width:100%">
                <thead>
                ...
                @forelse($fees as $fee)
                    <tr class="border-t hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-center flex gap-2 justify-center">
                            ...
                            <form method="POST" action="{{ route('fee.destroy', $fee) }}">
                                @csrf @method('DELETE')
    ...
    @push('scripts')
    <x-datatable-init table-id="ptoFeeTable" />
    @endpush
        ...
        @forelse($fees as $fee)
            <div class="bg-white rounded-xl shadow p-4 space-y-3 border-l-4 border-[#00285E]">
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <form method="POST" action="{{ route('fee.destroy', $fee) }}" class="flex-1">
                        @csrf @method('DELETE')
                        <button onclick="return confirm('Delete this fee?')"
