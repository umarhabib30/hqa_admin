...
<div>
    <div class="flex justify-between mb-6 md:flex-row flex-col">
        <h1 class="text-2xl font-semibold">Pto Gallery</h1>

        <a href="{{ route('ptoImages.create') }}"
