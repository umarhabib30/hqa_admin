...
<div>
    ...
    <div class="hidden md:block bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="overflow-x-auto p-4">
            <table id="ptoEventsTable" class="display w-full text-left" style="width:100%">
                <thead>
                    <tr class="bg-gray-50/80 text-gray-500 text-xs uppercase tracking-wider font-bold">
                        ...
                        <th class="px-4 py-3 border-b border-gray-200">Event Image</th>
    ...
    @push('scripts')
    <x-datatable-init table-id="ptoEventsTable" />
    @endpush
