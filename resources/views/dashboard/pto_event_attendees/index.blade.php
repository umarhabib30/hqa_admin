    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="hidden lg:block bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="overflow-x-auto p-4">
                <table id="ptoAttendeesTable" class="display w-full text-left" style="width:100%">
                    <thead>
        ...
        @push('scripts')
        <x-datatable-init table-id="ptoAttendeesTable" />
        @endpush
        ...
        <div class="lg:hidden space-y-4">
            ...
            @empty
                <div class="text-center text-gray-500 py-12 bg-white rounded-xl shadow-sm border border-dashed">No attendees
                    found.</div>
            @endforelse
        </div>
    </div>
